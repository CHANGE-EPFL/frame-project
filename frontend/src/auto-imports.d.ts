...
declare global {
  ...
  const metadataStore: (typeof import('./stores/metadata'))['metadataStore'];
...
declare global {
  ...
  export type {
    ...
    MachineLearningComponentFromFile,
    MachineLearningComponentReference,
    MachineLearningComponentSummary,
  } from './models/machine_learning_component';
  import('./models/machine_learning_component');
  // @ts-ignore
  export type {
    Component,
    ComponentFromFile,
    ...
    PhysicsBasedComponentFromFile,
    PhysicsBasedComponentReference,
    PhysicsBasedComponentSummary,
  } from './models/physics_based_component';
  import('./models/physics_based_component');
  // @ts-ignore
